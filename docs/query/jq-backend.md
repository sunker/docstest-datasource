...
For details on available operators and expression syntax, refer to the [Computed columns section in the JSONata backend parser documentation](./backend.md#computed-columns).
