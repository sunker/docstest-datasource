...
> **Note:** In previous versions of the data source, this was referred to as the *backend parser*. In the current version, the *backend* is a parser category that includes both `JSONata` and `JQ` parsers.
...
![calculated fields](img/196197153-306bbf2a-bc95-4be2-b3ad-75e12c8ea404.jpg)
...
![Filter expression](img/196344664-33733b04-3ac9-4c00-9c3c-970a9cb63bb3.jpg)
