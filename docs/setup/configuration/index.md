...
![image](img/118472644-f4ceab00-b700-11eb-89e1-eec404755cd0.jpg)
...
For more information, refer to the URL configuration reference in the references section.

## Network

For configuring network settings such as proxy setting, refer the [Network Documentation](./network.md)
...
> **Warning:** Infinity doesn't validate any permissions against the underlying API. Enable this setting with caution as this can potentially perform any destructive action in the underlying API.
