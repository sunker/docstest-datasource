...
[Learning journey: Visualize JSON data using the Infinity data source](https://grafana.com/docs/learning-journeys/infinity-json/)

![Sample JSON Query in Infinity datasource](img/189874914-6b49d3ec-2030-46ea-b14e-fdd48628345e.jpg)

[Try it live: Infinity plugin JSON demo](https://play.grafana.org/d/infinity-json)
...
![image](img/108413678-34314c80-7223-11eb-9cce-603134ec2d48.jpg)
...
![image](img/108415043-de5da400-7224-11eb-9295-d49fcc18464a.jpg)
...
![image](img/108427049-7dd66300-7234-11eb-8d27-cec50945a66c.jpg)
...
![image](img/108415716-cdf9f900-7225-11eb-8e0d-5d767104a080.jpg)
...
> **Note:** Any root selector that starts with `$` is considered as JSONPath selector.

![image](img/100856870-ddb63c80-3483-11eb-8e3c-791c161d3cc7.jpg)
...
If you are looking for more JSON options like `group by`, `order by`, JSONata, field manipulation or similar, then use [UQL query](./query/uql.md). Below you will find a UQL command:
...
![UQL Parser](img/189878439-ec8266e3-cb16-4cbf-8718-2371a3a7276c.jpg)

## Backend Parser

If you need advanced options such as alerting/recorded queries, then use `backend` as the parser.

![backend parser](img/189875668-3ac061a9-c548-4bfe-abcc-6d0d7e6bdb55.jpg)
...
![summarize option in backend parser](img/189877393-b7d83da7-0e1d-41cd-a003-814bb2963347.jpg)
