...
[Try it live: Infinity plugin XML demo](https://play.grafana.org/d/infinity-xml)

The following example, uses an XML response in Grafana:

![image](img/99292060-a0716e00-2838-11eb-9af8-cf87adfd8fd5.jpg)
...
![image](img/99293208-39ed4f80-283a-11eb-831e-ae14d297a2f3.jpg)

The following image shows a sample example visualized using bar gauge panel and time series format:

![image](img/99294213-a9b00a00-283b-11eb-9b8b-26842c2bc69b.jpg)
