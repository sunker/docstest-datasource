...
description: Guides how AI agents author, maintain, review and validate the multi-page docs for Clock
---
...
This folder contains the multi-page documentation for the **Clock** plugin. Pages here are rendered by `@grafana/plugin-docs-parser` and published to `grafana.com/grafana/plugins/<slug>/docs/<page>`.
...
- Nested folders become nested URLs (Docusaurus-style). `<docsPath>/options/legend.md` becomes `.../<docsPath>/options/legend`.
