...
![image](img/198975951-1642f55d-e2a8-4eab-ae18-b2f2a9d3fce1.jpg)

Below image is the example on how to query it.

![image](img/198976089-0736c591-2a53-4aac-a58f-00f3c92797f8.jpg)

> **Note:** We suggest to add only small size data as reference data. It's designed to support data of less than 10 MB. Adding data of bigger size may affect the performance of Grafana and the plugin.
